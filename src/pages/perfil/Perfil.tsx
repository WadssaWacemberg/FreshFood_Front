...
function Perfil() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#fff3d1] p-4 lg:p-8 justify-center items-center"> 
      ...
      <div className='w-full max-w-4xl bg-white rounded-3xl shadow-2xl border border-[#19401f]/10 overflow-hidden relative'>
